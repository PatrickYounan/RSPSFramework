...
public final class CacheFileManager {
     ...
     */
    private ContainerSegmentData information;

    /**
     * Discard a files data.
     */
    private final boolean discardFilesData;
    ...
    public CacheFileManager(CacheFile cacheFile, boolean discardFilesData) {
        ...
        information = new ContainerSegmentData(informContainerPackedData);
        resetFilesData();
    }
     ...
     */
    public ContainerSegmentData getInformation() {
        return information;
    }
}
