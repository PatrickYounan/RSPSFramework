...
public final class BZip2Decompressor {
    ...
    private static final BZip2BlockEntry INSTANCE = new BZip2BlockEntry();

    private static int[] anIntArray257;

    public static void decompress(byte[] decompressedData, byte[] packedData, int blockSize) {
        INSTANCE.aByteArray2224 = packedData;
        INSTANCE.anInt2209 = blockSize;
        INSTANCE.aByteArray2212 = decompressedData;
        INSTANCE.anInt2203 = 0;
        INSTANCE.anInt2206 = decompressedData.length;
        INSTANCE.anInt2232 = 0;
        INSTANCE.anInt2207 = 0;
        INSTANCE.anInt2217 = 0;
        INSTANCE.anInt2216 = 0;
        method1793(INSTANCE);
        INSTANCE.aByteArray2224 = null;
        INSTANCE.aByteArray2212 = null;
    }
    ...
    private static void method1786(int[] ai, int[] ai1, int[] ai2, byte[] data, int i, int j, int k) {
        int l = 0;
    ...
    private static byte method1789(BZip2BlockEntry entryInstance2) {
    ...
    private static void method1793(BZip2BlockEntry entryInstance2) {
        int j8 = 0;
        int[] ai = null;
        int[] ai1 = null;
        int[] ai2 = null;
        ...
        while (flag18) {
            ...
            for (int j1 = 0; j1 < k4; j1++) {
                ...
                byte byte15 = data[byte17];
                for (; byte17 > 0; byte17--) {
                    data[byte17] = data[byte17 - 1];
                }
            ...
            System.arraycopy(entryInstance2.anIntArray2228, 0, entryInstance2.anIntArray2220, 1, 256);
